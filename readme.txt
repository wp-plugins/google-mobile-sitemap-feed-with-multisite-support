...
Genera dinámicamente un mapa de sitio para móviles de Google, informando a Google y Bing automáticamente. 

No requiere configuración.

== Description ==

Genera dinámicamente un mapa de sitio para móviles de Google, informando a Google y Bing automáticamente cada vez que publiquemos una nueva entrada o página.
